...
namespace WeChatPortal.Utils
{
    public class ConfigSetting
    {
        ...
        private const string CodeHashKey = "CodeHash";
        ...
        public static string EncodingAesKey => GetString(EncodingAesKeyName, "");
        ...
        public static string CodeHash => GetString(CodeHashKey, "abcdefghijklmnopqrstuvwxyz0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ");
